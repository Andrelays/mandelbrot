...
(
    ...
    static void write_subtree_to_dot    (const id_parametrs *id_array, const tree_node *tree_node_pointer, FILE *dot_file);
...
(
    static void write_log_to_dot(const tree *tree_pointer, FILE *dot_file, ssize_t line, const char *file, const char *func)
    {
        ...
        write_subtree_to_dot(tree_pointer->id_array, tree_pointer->root, dot_file);
...
(
    ...
    {
        MYASSERT(dot_file       != NULL, NULL_POINTER_PASSED_TO_FUNC, return);
        MYASSERT(id_array != NULL, NULL_POINTER_PASSED_TO_FUNC, return);
        ...
        {
            write_subtree_to_dot(id_array, tree_node_pointer->left, dot_file);
        ...
        {
            write_subtree_to_dot(id_array, tree_node_pointer->right, dot_file);
